...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoodItem.price'
        db.alter_column(u'public_fooditem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'FoodItem.price'
        db.alter_column(u'public_fooditem', 'price', self.gf('django.db.models.fields.IntegerField')(max_length=9))
