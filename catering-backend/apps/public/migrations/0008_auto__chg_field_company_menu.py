...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'public_company', 'menu_id', self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['public.Menu'], unique=True))
    ...
    models = {
        u'public.company': {
            ...
            'menu': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['public.Menu']", 'unique': 'True'}),
